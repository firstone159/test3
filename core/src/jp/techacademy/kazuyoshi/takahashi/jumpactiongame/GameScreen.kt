...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    ...
    init {
        ...
        //効果音のファイル指定
        mSound = Gdx.audio.newSound(Gdx.files.internal("slime1.mp3"))

        // ハイスコアをPreferencesから取得する
        mPrefs = Gdx.app.getPreferences("jp.techacademy.kazuyoshi.takahashi.jumpactiongame") // ←追加する
    ...
    private fun createStage() {
        ...
        val enemyTexture = Texture("eirian.png")
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.8f) {
                val enemy = Enemy(enemyTexture,0,0,120,233)
